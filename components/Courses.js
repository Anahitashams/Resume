    ...
    <div dir="rtl" id="experience" className="py-10 mb-20">
      ...
      <div className="flex flex-col items-center space-y-10 mt-16">
        <ol className="flex flex-col sm:flex-row w-full max-w-5xl justify-center items-center gap-10">
          {[
            {
              title: " شرکت نرم افزاری اویک در کرج",
              date: "شروع از سال 1402 همچنان مشغول به کار",
            },
            {
              title: "فعالیت در لینکدین و اینستاگرام ",
              date: "شروع از سال 1399 همچنان مشغول به کار",
            },
            {
              title: "شرکت آچاره ساز در تهران",
              date: "شروع از سال 1399 تا سال 1401",
            },
          ].map((item, idx) => (
            <li
              key={idx}
